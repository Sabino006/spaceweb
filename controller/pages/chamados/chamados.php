    ...
    <section id="background">
        <div class="chamados">
            <table>
                ...
                <?php while($chamados = $con->fetch_array()) {?>
                <tr class="conteudo">
                    <td><?php echo $chamados["ID"];  ?></td>
                    <td><?php echo $chamados["NOME_USUARIO"];  ?></td>
                    <td><?php echo $chamados["TIPO"];  ?></td>
                    <td><?php echo $chamados["NIVEL"];  ?></td>
                    <td><?php echo $chamados["STATUS_CHAMADO"];  ?></td>
                    <td><?php echo $chamados["NOME_ANALISTA"];  ?></td>
                    <td><a href="altera_chamado.php?id=<?php echo $chamados['ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td><a href="../../scripts/chamados/deletar_chamado.php?id=<?php echo $chamados['ID'] ?>"><i class="fa-regular fa-trash-can"></i></a></td>
                </tr>
                <?php } ?> 
            </table>
        </div>
