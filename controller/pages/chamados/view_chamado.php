                ...
                <div class="chamados_alterar">
                    ...
                    <form action="" method="">
                        ...
                        <div class="status">
                            ...
                            <input type="text" value=" <?php echo $status ?>" required readonly>
                        </div>
                        <div class="codigo">
                            <label for="">ID Analista</label>
                            <input name="id_analista" type="text" value="<?php echo $id_analista ?>" required readonly>
                        </div>
                        <div class="usuario">
                            <label for="">Analista:</label>
                            <input name="nome_analista" type="text" value="<?php echo $nome_analista ?>" readonly aria-readonly="">
                        </div>
                        <div class="links">
                            <a href="../chamados/meus_chamados.php">Voltar</a>
                        </div>
                    </form>
                </div>
            </div>
