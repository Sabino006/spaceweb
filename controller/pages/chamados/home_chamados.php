...
<body>
    ...
    <section id="background">
        <div class="content-equipe">
            <div class="links">
                <div class="line">
                    <a href="chamados.php"><i class="fa-solid fa-headset"></i><p>Chamados</p></a>
                    <a href="criar_chamado.php"><i class="fa-solid fa-plus"></i><p>Novo chamado</p></a>
                </div>
                <div class="line">
                    <a href="meus_chamados.php"><i class="fa-solid fa-person-circle-exclamation"></i><p>Meus Chamados</p></a>
