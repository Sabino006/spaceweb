                        ...
                        <form action="../../scripts/pedidos/atualizar_pedido.php" method="POST">
                            <div class="vendedor">
                                ...
                                <div class="codigo">
                                    ...
                                    <input name="id_gerente" type="text" value="<?php echo $_SESSION['SESSION_ID'] ?>" readonly>
                                </div>
                                <div class="nome">
                                    <label for="">Nome: </label>
                                    <input name="nome_gerente" type="text" value="<?php echo $_SESSION['SESSION_NOME'] ?> &nbsp; <?php echo $_SESSION['SESSION_SOBRENOME'] ?>" readonly>
                                </div>
                                <div class="cpf">
                                    <label for="">CPF: </label>
                                    <input name="cpf_gerente" type="text" value="<?php echo $_SESSION['SESSION_CPF'] ?>" readonly>
                                </div>
                                <div class="titulo-vendedor">
