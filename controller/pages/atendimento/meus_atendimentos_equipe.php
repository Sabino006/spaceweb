    ...
    <section id="background">
        <div class="atendimentos">
            <table>
                ...
                <?php while($vendedor = $conVendedor->fetch_array()) {?>
                <tr class="conteudo">
                    <td><?php echo $vendedor["ID"];  ?></td>
                    <td><?php echo $vendedor["NOME_CLIENTE"];  ?></td>
                    <td><?php echo $vendedor["SERVICO"];  ?></td>
                    <td><?php echo $vendedor["STATUS_ATENDIMENTO"];  ?></td>
                    <td><?php echo $vendedor["NOME_VENDEDOR"];  ?></td>
                    <td><a href="alterar_atendimento.php?id=<?php echo $vendedor['ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td><a href="view_atendimento.php?id=<?php echo $vendedor['ID'] ?>"><i class="fa-solid fa-eye"></i></a></td>
                    <td><a href="../../scripts/atendimento/deletar_atendimento.php?id=<?php echo $vendedor['ID'] ?>"><i class="fa-regular fa-trash-can"></i></a></td>
                </tr>
                <?php } ?> 
            </table>
        </div>
