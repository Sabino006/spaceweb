    ...
    <section id="background">
        <div class="atendimentos">
            <table>
                ...
                <?php while($Cliente = $conCliente->fetch_array()) {?>
                <tr class="conteudo">
                    <td><?php echo $Cliente["ID"];  ?></td>
                    <td><?php echo $Cliente["NOME_CLIENTE"];  ?></td>
                    <td><?php echo $Cliente["SERVICO"];  ?></td>
                    <td><?php echo $Cliente["STATUS_ATENDIMENTO"];  ?></td>
                    <td><?php echo $Cliente["NOME_VENDEDOR"];  ?></td>
                    <td><a href="view_atendimento.php?id=<?php echo $Cliente['ID'] ?>"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
                <?php } ?> 
            </table>
        </div>
