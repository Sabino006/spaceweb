...
include('../../scripts/atendimento/listar_atendimento.php');
  ...
  if (!isset($_SESSION["SESSION_ID"]) OR ($_SESSION["SESSION_PERMISSAO"] < $nivel_necessario)) {
      ...
      header("Location: ../../../controller/pages/atendimento/home_atendimento.php"); 
  }
    ...
    <section id="background">
        <div class="atendimentos">
            <table>
                ...
                <?php while($andamento = $conAndamento->fetch_array()) {?>
                <tr class="conteudo">
                    <td><?php echo $andamento["ID"];  ?></td>
                    <td><?php echo $andamento["NOME_CLIENTE"];  ?></td>
                    <td><?php echo $andamento["SERVICO"];  ?></td>
                    <td><?php echo $andamento["STATUS_ATENDIMENTO"];  ?></td>
                    <td><?php echo $andamento["NOME_VENDEDOR"];  ?></td>
                    <td><a href="alterar_atendimento.php?id=<?php echo $andamento['ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td><a href="view_atendimento.php?id=<?php echo $andamento['ID'] ?>"><i class="fa-solid fa-eye"></i></a></td>
                    <td><a href="../../scripts/atendimento/deletar_atendimento.php?id=<?php echo $andamento['ID'] ?>"><i class="fa-regular fa-trash-can"></i></a></td>
                </tr>
                <?php } ?> 
            </table>
        </div>
