    ...
    <section id="background">
        <div class="usuarios">
            <table>
                ...
                <?php while($user = $con->fetch_array()) {?>
                <tr class="conteudo">
                    ...
                    <td><a href="user_edit.php?id=<?php echo $user['ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td><a href="../../scripts/usuarios/deletar.php?id=<?php echo $user['ID'] ?>"><i class="fa-regular fa-trash-can"></i></a></td>
                </tr>
                <?php } ?> 
            </table>
        </div>
