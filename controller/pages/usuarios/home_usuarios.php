<?php
  ...
  if (!isset($_SESSION["SESSION_ID"]) OR ($_SESSION["SESSION_PERMISSAO"] < $nivel_necessario)) {
    // Redireciona o visitante de volta pro login
      header("Location: ../home_equipe.php"); 
  }
...
<body>
    ...
    <section id="background">
        <div class="content-equipe">
            <div class="links">
                <div class="line">
                    <a href="usuarios.php"><i class="fa-solid fa-users"></i><p>Usuarios</p></a>
                    <a href="cadastrar_usuario.php"><i class="fa-solid fa-user-plus"></i><p>Novo cadastro</p></a>
                </div>
                <div class="line">
                    <a href="clientes.php"><i class="fa-solid fa-user-group"></i><p>Clientes</p></a>
