                ...
                <div class="basic-info">
                    ...
                    <div class="info-perfil-atualizar">
                        ...
                        <div class="info-int-2">
                            <form action="../../../controller/scripts/usuarios/atualizar_cadastro.php" method="POST">
                                ...
                                <div class="atualizar-telefone">
                                    ...
                                    <input name="telefone" type="text" id="telefone" placeholder="(00) 00000-0000" maxlength="15" minlength="12" value="<?php echo $telefone ?>" required>
                                </div>
                                <div class="atualizar-cpf">
                                    <label for="">CPF:</label>
                                    <input  name="cpf" id="cpf" maxlength="14" minlength="14" type="text" value="<?php echo $cpf ?>" required>
                                </div>
